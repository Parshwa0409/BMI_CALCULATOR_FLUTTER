                        ...
                        onTap: () {
                          try {
                            if (_heightValue == 0 ||
                                ...
                                _weight == 0) {
                              throw Exception(
                                  'Null Value , i.e 0 for "Age or Height or Weight" not expected , please give non null or non zero value...');
                            }
                            var bmiValue;
                            Brain calc = Brain(
                                height: _heightValue.toInt(), weight: _weight);
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ResultPage(
                                  ...
                                  value: bmiValue,
                                  recommendation: calc.recommendation(bmiValue),
                                ),
                              ),
                            );
                          } catch (e) {
